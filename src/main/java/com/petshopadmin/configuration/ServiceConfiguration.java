...
import com.petshopadmin.adapter.output.repository.database.service.ServiceJPARepository;
...
public class ServiceConfiguration {
    ...
    ServiceRepositoryDatabase serviceRepositoryDatabase(ServiceJPARepository serviceJPARepository ) {
        return new com.petshopadmin.adapter.output.repository.database.service.ServiceRepositoryDatabase(serviceJPARepository);
    }
